...
func (x *Package) GetSpackMetadata() *SpackPackageMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*Package_SpackMetadata); ok {
...
func (x *SecretData) GetPackagistOrgReadToken() *SecretData_PackagistOrgReadToken {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_PackagistOrgReadToken_); ok {
...
func (x *SecretData) GetPackagistOrgUpdateToken() *SecretData_PackagistOrgUpdateToken {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_PackagistOrgUpdateToken_); ok {
...
func (x *SecretData) GetPackagistUserUpdateToken() *SecretData_PackagistUserUpdateToken {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_PackagistUserUpdateToken_); ok {
...
func (x *SecretData) GetPackagistConductorUpdateToken() *SecretData_PackagistConductorUpdateToken {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_PackagistConductorUpdateToken_); ok {
...
func (x *SecretData) GetDiscordBotToken() *SecretData_DiscordBotToken {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_DiscordBotToken_); ok {
...
func (x *SecretData) GetBitwardenOauth2AccessToken() *SecretData_BitwardenOAuth2AccessToken {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_BitwardenOauth2AccessToken); ok {
...
func (x *SecretData) GetHttpBasicAuth() *SecretData_HTTPBasicAuth {
	if x != nil {
		if x, ok := x.Secret.(*SecretData_HttpBasicAuth); ok {
...
func (x *LocationLegacy) GetFilepath() *Filepath {
	if x != nil {
		if x, ok := x.Location.(*LocationLegacy_Filepath); ok {
			return x.Filepath
		}
	}
	return nil
...
func (x *LocationLegacy) GetFilepathWithLayerDetails() *FilepathWithLayerDetails {
	if x != nil {
		if x, ok := x.Location.(*LocationLegacy_FilepathWithLayerDetails); ok {
...
func (x *LocationLegacy) GetEnvironmentVariable() *EnvironmentVariable {
	if x != nil {
		if x, ok := x.Location.(*LocationLegacy_EnvironmentVariable); ok {
...
func (x *LocationLegacy) GetContainerCommand() *ContainerCommand {
	if x != nil {
		if x, ok := x.Location.(*LocationLegacy_ContainerCommand); ok {
...
const file_proto_scan_result_proto_rawDesc = "" +
	"\n" +
	"\x17proto/scan_result.proto\x12\ascalibr\x1a\x19google/protobuf/any.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x19proto/vulnerability.proto\"\xbf\x02\n" +
	"\n" +
	"ScanResult\x12\x18\n" +
	...
	"\tinventory\x18\b \x01(\v2\x12.scalibr.InventoryR\tinventoryJ\x04\b\x06\x10\aJ\x04\b\a\x10\b\"\x92\x03\n" +
	"\tInventory\x12,\n" +
	...
	"\x18container_image_metadata\x18\x05 \x03(\v2\x1f.scalibr.ContainerImageMetadataR\x16containerImageMetadata\x12R\n" +
	"\x15sensitive_information\x18\a \x03(\v2\x1d.scalibr.SensitiveInformationR\x14sensitiveInformation\"\xfb\x01\n" +
	"\n" +
	"ScanStatus\x12:\n" +
	...
	"\tlocations\x18\x02 \x03(\tB\x02\x18\x01R\tlocations\x124\n" +
	"\blocation\x18D \x01(\v2\x18.scalibr.PackageLocationR\blocation\x12\x18\n" +
	"\aplugins\x181 \x03(\tR\aplugins\x12<\n" +
	"\fmetadata_any\x18E \x01(\v2\x14.google.protobuf.AnyH\x01R\vmetadataAny\x88\x01\x01\x12I\n" +
	...
	"\x10\vJ\x04\b\x1c\x10\x1dJ\x04\b#\x10$J\x04\b\x11\x10\x15J\x04\b\x1d\x10\x1eJ\x04\b \x10!J\x04\b+\x10,J\x04\b;\x10<\"e\n" +
	"\x0fPackageLocation\x12%\n" +
	"\x04desc\x18\x01 \x01(\v2\x11.scalibr.LocationR\x04desc\x12+\n" +
	"\arelated\x18\x02 \x03(\v2\x11.scalibr.LocationR\arelated\"B\n" +
	...
	"\tdeveloper\x18\t \x01(\tR\tdeveloper\"\x9c\x01\n" +
	"\x14SpackPackageMetadata\x12\x1a\n" +
	...
	"\n" +
	"base_image\x18\x02 \x01(\bR\tbaseImage\"\xce\x01\n" +
	"\x06Secret\x12+\n" +
	...
	"\blocation\x18\x04 \x01(\v2\x11.scalibr.LocationR\blocation\"\xe1r\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x19supabase_service_role_jwt\x18O \x01(\v2*.scalibr.SecretData.SupabaseServiceRoleJWTH\x00R\x16supabaseServiceRoleJwt\x12Q\n" +
	"\x11packagist_api_key\x18P \x01(\v2#.scalibr.SecretData.PackagistAPIKeyH\x00R\x0fpackagistApiKey\x12Z\n" +
	"\x14packagist_api_secret\x18Q \x01(\v2&.scalibr.SecretData.PackagistAPISecretH\x00R\x12packagistApiSecret\x12d\n" +
	"\x18packagist_org_read_token\x18R \x01(\v2).scalibr.SecretData.PackagistOrgReadTokenH\x00R\x15packagistOrgReadToken\x12j\n" +
	"\x1apackagist_org_update_token\x18S \x01(\v2+.scalibr.SecretData.PackagistOrgUpdateTokenH\x00R\x17packagistOrgUpdateToken\x12m\n" +
	"\x1bpackagist_user_update_token\x18T \x01(\v2,.scalibr.SecretData.PackagistUserUpdateTokenH\x00R\x18packagistUserUpdateToken\x12|\n" +
	...
	"\x1dbitwarden_oauth2_access_token\x18X \x01(\v2..scalibr.SecretData.BitwardenOAuth2AccessTokenH\x00R\x1abitwardenOauth2AccessToken\x12K\n" +
	"\x0fhttp_basic_auth\x18Y \x01(\v2!.scalibr.SecretData.HTTPBasicAuthH\x00R\rhttpBasicAuth\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
	...
	"\x13verifier_local_hash\x18\b \x01(\tR\x11verifierLocalHash\x1aj\n" +
	...
	"\x03key\x18\x02 \x01(\tR\x03key\x1aH\n" +
	"\x15PackagistOrgReadToken\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12\x19\n" +
	"\brepo_url\x18\x02 \x01(\tR\arepoUrl\x1aJ\n" +
	"\x17PackagistOrgUpdateToken\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12\x19\n" +
	"\brepo_url\x18\x02 \x01(\tR\arepoUrl\x1ag\n" +
	"\x18PackagistUserUpdateToken\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\x12\x19\n" +
	"\brepo_url\x18\x03 \x01(\tR\arepoUrl\x1a5\n" +
	"\x1dPackagistConductorUpdateToken\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x1a(\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x1a'\n" +
	"\x0fDiscordBotToken\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x1a\xb1\x01\n" +
	...
	"privateKey\x1a^\n" +
	"\x1aBitwardenOAuth2AccessToken\x12\x1b\n" +
	"\tclient_id\x18\x01 \x01(\tR\bclientId\x12#\n" +
	"\rclient_secret\x18\x02 \x01(\tR\fclientSecret\x1aG\n" +
	...
	"\n" +
	"\x06FAILED\x10\x05\"\xce\x02\n" +
	"\x0eLocationLegacy\x12/\n" +
	...
	"\aos_info\x18\x04 \x03(\v2+.scalibr.ContainerImageMetadata.OsInfoEntryR\x06osInfo\x12C\n" +
	"\x06labels\x18\x05 \x03(\v2+.scalibr.ContainerImageMetadata.LabelsEntryR\x06labels\x1a9\n" +
	...
	"\x14SensitiveInformation\x12.\n" +
	"\tinfo_type\x18\x01 \x01(\v2\x11.scalibr.InfoTypeR\binfoType\x123\n" +
	"\n" +
	"likelihood\x18\x02 \x01(\x0e2\x13.scalibr.LikelihoodR\n" +
	"likelihood\x12\x10\n" +
	"\x03raw\x18\x03 \x01(\fR\x03raw\x12-\n" +
	"\blocation\x18\x04 \x01(\v2\x11.scalibr.LocationR\blocation*\xf7\x01\n" +
	...
	"\x05LOCAL\x10\x03*\xab\x01\n" +
	"\x10SensitivityLevel\x12!\n" +
	"\x1dSENSITIVITY_LEVEL_UNSPECIFIED\x10\x00\x12\x19\n" +
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 175)
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_CursorAPIKey)(nil),                         // 174: scalibr.SecretData.CursorAPIKey
	(*SecretData_CircleCIPersonalAccessToken)(nil),          // 175: scalibr.SecretData.CircleCIPersonalAccessToken
	(*SecretData_CircleCIProjectToken)(nil),                 // 176: scalibr.SecretData.CircleCIProjectToken
	(*SecretData_URLCredentials)(nil),                       // 177: scalibr.SecretData.URLCredentials
	(*SecretData_SquarePersonalAccessToken)(nil),            // 178: scalibr.SecretData.SquarePersonalAccessToken
	(*SecretData_SquareOAuthApplicationSecret)(nil),         // 179: scalibr.SecretData.SquareOAuthApplicationSecret
	nil,                             // 180: scalibr.ContainerImageMetadata.OsInfoEntry
	nil,                             // 181: scalibr.ContainerImageMetadata.LabelsEntry
	(*timestamppb.Timestamp)(nil),   // 182: google.protobuf.Timestamp
	(*anypb.Any)(nil),               // 183: google.protobuf.Any
	(*osvschema.Vulnerability)(nil), // 184: osv.Vulnerability
	(*durationpb.Duration)(nil),     // 185: google.protobuf.Duration
}
var file_proto_scan_result_proto_depIdxs = []int32{
	182, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	182, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	183, // 17: scalibr.Package.metadata_any:type_name -> google.protobuf.Any
	...
	184, // 69: scalibr.PackageVuln.vuln:type_name -> osv.Vulnerability
	...
	182, // 80: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	182, // 81: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	...
	174, // 147: scalibr.SecretData.cursor_api_key:type_name -> scalibr.SecretData.CursorAPIKey
	161, // 148: scalibr.SecretData.elastic_cloud_api_key:type_name -> scalibr.SecretData.ElasticCloudAPIKey
	177, // 149: scalibr.SecretData.url_credentials:type_name -> scalibr.SecretData.URLCredentials
	...
	175, // 154: scalibr.SecretData.circleci_personal_access_token:type_name -> scalibr.SecretData.CircleCIPersonalAccessToken
	176, // 155: scalibr.SecretData.circleci_project_token:type_name -> scalibr.SecretData.CircleCIProjectToken
	178, // 156: scalibr.SecretData.square_personal_access_token:type_name -> scalibr.SecretData.SquarePersonalAccessToken
	179, // 157: scalibr.SecretData.square_oauth_application_secret:type_name -> scalibr.SecretData.SquareOAuthApplicationSecret
	...
	6,   // 177: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	182, // 178: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	76,  // 179: scalibr.LocationLegacy.filepath:type_name -> scalibr.Filepath
	77,  // 180: scalibr.LocationLegacy.filepath_with_layer_details:type_name -> scalibr.FilepathWithLayerDetails
	78,  // 181: scalibr.LocationLegacy.environment_variable:type_name -> scalibr.EnvironmentVariable
	79,  // 182: scalibr.LocationLegacy.container_command:type_name -> scalibr.ContainerCommand
	15,  // 183: scalibr.FilepathWithLayerDetails.layer_details:type_name -> scalibr.LayerDetails
	81,  // 184: scalibr.Location.file:type_name -> scalibr.File
	85,  // 185: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	83,  // 186: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	180, // 187: scalibr.ContainerImageMetadata.os_info:type_name -> scalibr.ContainerImageMetadata.OsInfoEntry
	181, // 188: scalibr.ContainerImageMetadata.labels:type_name -> scalibr.ContainerImageMetadata.LabelsEntry
	84,  // 189: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
	3,   // 190: scalibr.InfoType.sensitivity:type_name -> scalibr.SensitivityLevel
	86,  // 191: scalibr.SensitiveInformation.info_type:type_name -> scalibr.InfoType
	4,   // 192: scalibr.SensitiveInformation.likelihood:type_name -> scalibr.Likelihood
	80,  // 193: scalibr.SensitiveInformation.location:type_name -> scalibr.Location
	61,  // 194: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
	165, // 195: scalibr.SecretData.HerokuSecretKey.heroku_secret_key_metadata:type_name -> scalibr.SecretData.HerokuSecretKeyMetadata
	185, // 196: scalibr.SecretData.HerokuSecretKeyMetadata.expire_time:type_name -> google.protobuf.Duration
